...
class LinearChartWidget extends StatefulWidget {
  ...
  State<StatefulWidget> createState() => _LinearChartScreenState();
...
class _LinearChartScreenState extends State<LinearChartWidget> {
  ...
  void makeSpots() {
    ...
    widget.webCijenik!.forEach((cijenik) {
      widget.goriva!.forEach((gorivo) {
